...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    function() {
        ...
        return "png" == i && t.parentNode.classList.add("layzr-bg-transparent"), t.getBoundingClientRect().top + window.pageYOffset
...
function(t) {
            ...
            t(this), new Layzr({
                ...
                callback: function() {
                    ...
                    e.parents(".fancy-media-wrap.photoswipe-wrapper").initPhotoswipe(), setTimeout((function() {
                        e.parents().removeClass("layzr-bg"), e.css("will-change", "auto")
                    }), 350)
                },
                after: function() {
                    var e = t(this);
    ...
    function h() {
        if (dtGlobals.isMobile) t(".skills").length > 0 && "undefined" != typeof animateSkills && the7Utils.isFunction(animateSkills) && t(".skills").animateSkills();
            ...
            a.length && (a.addClass(n), o = !0), (a = e.first().prev().find("img").not(s)).length && (a.addClass(n), o = !0), (a = e.find("img").not(s)).length && (a.addClass(n), o = !0), o && (i.updateSelector(), i.update())
    ...
    if (t.fn.photoswipeGallery = function(e) {
            ...
            t(".photoswipe-wrapper, .photoswipe-item .dt-gallery-container, .shortcode-gallery.dt-gallery-container:not(.owl-carousel), .dt-gallery-container.gallery:not(.gallery-size-the7_mphb_gallery_image_size), .instagram-photos.dt-gallery-container, .images-container .dt-gallery-container, .shortcode-instagram.dt-gallery-container, .gallery-shortcode:not(.owl-carousel)").initPhotoswipe()
    ...
    t.fn.the7OwlCarousel = function() {
        ...
        var e = t(this);
        if (e.length) {
            var i, n, s = e.attr("data-col-gap") ? parseInt(e.attr("data-col-gap")) : 0,
                o = e.attr("data-col-gap-tablet") ? parseInt(e.attr("data-col-gap-tablet")) : s,
                a = e.attr("data-col-gap-mobile") ? parseInt(e.attr("data-col-gap-mobile")) : o,
                r = "true" === e.attr("data-auto-height"),
                l = e.attr("data-speed") ? parseInt(e.attr("data-speed")) : 600,
                d = "true" === e.attr("data-autoplay"),
                h = e.attr("data-autoplay_speed") ? parseInt(e.attr("data-autoplay_speed")) : 6e3,
                u = "true" === e.attr("data-arrows"),
                p = "true" === e.attr("data-arrows_tablet"),
                f = "true" === e.attr("data-arrows_mobile"),
                m = "true" === e.attr("data-bullet"),
                g = "true" === e.attr("data-bullet_tablet"),
                v = "true" === e.attr("data-bullet_mobile"),
                y = void 0 !== elementorFrontendConfig.breakpoints.md ? elementorFrontendConfig.breakpoints.md : 481,
                w = void 0 !== elementorFrontendConfig.breakpoints.lg ? elementorFrontendConfig.breakpoints.lg : 769,
                b = void 0 !== dtLocal.elementor.settings.container_width ? dtLocal.elementor.settings.container_width + 1 : 1450,
                _ = e.attr("data-col-num") ? parseInt(e.attr("data-col-num")) : 3,
                x = e.attr("data-wide-col-num") ? parseInt(e.attr("data-wide-col-num")) : _,
                I = (e.attr("data-laptop-col") && parseInt(e.attr("data-laptop-col")), e.attr("data-h-tablet-columns-num") ? parseInt(e.attr("data-h-tablet-columns-num")) : 3),
                S = (e.attr("data-v-tablet-columns-num") && parseInt(e.attr("data-v-tablet-columns-num")), e.attr("data-phone-columns-num") ? parseInt(e.attr("data-phone-columns-num")) : 1),
                T = "rtl" == jQuery(document).attr("dir"),
                k = "1" == e.attr("data-scroll-mode") ? parseInt(e.attr("data-scroll-mode")) : "page",
                z = (e.attr("data-next-icon") && e.attr("data-next-icon"), e.attr("data-prev-icon") && e.attr("data-prev-icon"), !("1" != e.attr("data-scroll-mode") || !m));
            (n = e.hasClass("enable-img-shadow") ? parseInt(e.attr("data-stage-padding")) + parseInt(e.attr("data-col-gap")) / 2 : parseInt(e.attr("data-stage-padding"))) || (n = 0);
            var L = e.next(".owl-nav").find(".owl-prev").html(),
                E = e.next(".owl-nav").find(".owl-next").html();
            void 0 === e.attr("data-arrows_tablet") && (p = u), void 0 === e.attr("data-arrows_mobile") && (f = u), e.on("initialize.owl.carousel", (function(t) {
                c()
            }));
            var P = {};
            P[0] = {
                ...
                d && e.trigger("stop.owl.autoplay")
            })), e.find(".dt-owl-item").on("mouseleave", (function(t) {
                d && e.trigger("play.owl.autoplay", [h])
            })), e.find(".owl-nav a").on("mouseenter", (function(t) {
                d && e.trigger("stop.owl.autoplay")
            })), e.find(".owl-nav a").on("mouseleave", (function(t) {
                d && e.trigger("play.owl.autoplay", [h])
    ...
    function _e(e, i, n, s) {
        ...
        return e.each((function() {
            t(this).find(n).addClass(s), new Layzr({
                ...
                threshold: 30,
                before: function() {
                    "png" == t(this).attr("data-src").substring(t(this).attr("data-src").lastIndexOf(".") + 1) && t(this).parent().addClass("layzr-bg-transparent"), t(this).one("load", (function() {
                        t(this).parents(".woocom-project").length > 0 ? this.setAttribute("sizes", "(max-width:" + t(this).attr("width") + "px) 100vw," + t(this).attr("width") + "px") : this.setAttribute("sizes", this.width + "px"), this.style.willChange = "opacity"
                    }))
                },
                callback: function() {
                    ...
                    })), e.parents(".dt-isotope").length > 0 && o && (e.parents(".dt-isotope").isotope("layout"), o = !1)
                }
            })
        }))
    }
    ...
    dtGlobals.addOnloadEvent((function() {
        ...
        window.clickAnchorLink = function(e) {
            const i = e.attr("href"),
                n = We(i),
                s = Fe(n, i, e);
            return s && t(window).trigger("the7.anchorScrolling", [n, i, e]), t(".menu-item a").parent("li").removeClass("act"), t(".dt-nav-menu a").removeClass("active-item"), e.parents("li.menu-item ").addClass("act"), e.parents().hasClass("dt-nav-menu") && e.addClass("active-item"), s
    ...
    })), s.on("elementor/popup/show", (function(t, e, i) {
