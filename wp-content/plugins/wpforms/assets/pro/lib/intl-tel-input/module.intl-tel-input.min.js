...
(function(factory) {
    ...
    var factoryOutput = (() => {
        ...
        var M = (o, t) => {
            ...
            x = (o, t, e, i) => {
                if (t && typeof t == "object" || typeof t == "function")
                    for (let n of A(t)) !N.call(o, n) && n !== e && v(o, n, {
                        get: () => t[n],
                        enumerable: !(i = k(t, n)) || i.enumerable
                    });
                return o
            };
        var P = o => x(v({}, "__esModule", {
            value: !0
        }), o);
        var G = {};
        M(G, {
        ...
        var H = 0,
            ...
            f = o => o.replace(/\D/g, ""),
            E = (o = "") => o.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(),
            F = (o, t, e) => {
            ...
            b = class {
                ...
                constructor(t, e = {}) {
                    this.id = H++, this.a = t, this.b = null, this.c = null, this.d = Object.assign({}, D, e), this.e = !!t.getAttribute("placeholder")
                }
                _init() {
                    ...
                    !this.d.showFlags && t && (this.d.showFlags = !0), this.d.useFullscreenPopup && !this.d.dropdownContainer && (this.d.dropdownContainer = document.body), this.isRTL = !!this.a.closest("[dir=rtl]"), this.d.i18n = { ...T,
                        ...this.d.i18n
                    };
                ...
                _b() {
                    this._d(), this._d2(), this._e(), this._d0(), (this.d.onlyCountries.length || this.d.i18n) && this.p.sort(z)
                }
                _c(t, e, i) {
                ...
                _f() {
                    ...
                    if (this.a.parentNode ? .insertBefore(u, this.a), (i || e) && (this.k = h("div", {
                            class: "iti__country-container"
                        }, u), this.selectedCountry = h("button", {
                            type: "button",
                        ...
                        }, this.k), this.l = h("div", null, this.selectedCountry), this.selectedCountryA11yText = h("span", {
                            class: "iti__a11y-text"
                        }, this.l)), u.appendChild(this.a), this.selectedCountry && this.a.disabled && this.selectedCountry.setAttribute("aria-disabled", "true"), e && (this.t = h("div", {
                        ...
                        if (this.dropdownContent = h("div", {
                            ...
                            l ? g += " iti--fullscreen-popup" : g += " iti--inline-dropdown", a && (g += " iti--country-search"), this.dropdown = h("div", {
                                class: g
                ...
                _o() {
                    if (this.d.dropdownContainer && this.d.dropdownContainer.appendChild(this.dropdown), !this.d.useFullscreenPopup) {
                        ...
                        if (F(this.dropdownContent, "iti__dropdown-content--dropup", l), this.d.dropdownContainer) {
                            let a = l ? 0 : n;
                            this.dropdown.style.top = `${t.top+a}px`, this.dropdown.style.left = `${t.left}px`, this._a4 = () => this._2(), window.addEventListener("scroll", this._a4)
                        }
                    }
                }
                _p() {
                ...
                _z(t) {
                    let {
                        ...
                        countrySearch: s,
                        i18n: r
                    } = this.d, d = this.s.iso2 ? this.s : {};
                    if (this.s = t ? this._y(t, !1) || {} : {}, this.s.iso2 && (this.j = this.s.iso2), this.l) {
                        let l = "",
                            a = "";
                        t ? n && (l = `iti__flag iti__${t}`, a = `${this.s.name} +${this.s.dialCode}`) : (l = "iti__flag iti__globe", a = r.noCountrySelected), this.l.className = l, this.selectedCountryA11yText.textContent = a
                    }
                    if (this._z3(t, i), i) {
            ...
            j = o => !window.intlTelInputUtils && !window.intlTelInputGlobals.startedLoadingUtilsScript ? (window.intlTelInputGlobals.startedLoadingUtilsScript = !0, new Promise((t, e) => O(o, t, e))) : null;
